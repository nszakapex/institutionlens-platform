...
export const metadata: Metadata = {
  ...
  description:
    "Local-demo design-system and foundation preview. Not a product dashboard. Synthetic only.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        meta={<StatusBadge tone="info">Local foundation · Synthetic only</StatusBadge>}
      />
