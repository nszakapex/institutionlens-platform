...
const opsAnalyticsRuleSet = parseRuleSet({
  ...
  rules: [
    buildRule({
      ...
      title: "Institution kind fits prepayment and credit modeling demo scope",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: OPS_ID,
      factorCategory: "organizational_profile_fit",
      title: "Balance-sheet scale supports prepayment and credit modeling",
      rationale:
        "Mid-to-extra-large synthetic scale bands are stronger candidates for prepayment and credit modeling themes.",
      maximumPoints: 15,
    ...
    buildRule({
      ...
      title: "Digital service maturity aligns with mortgage analytics workflows",
      rationale:
        "Developing or established digital maturity aligns with model delivery and analytics workflows.",
      maximumPoints: 20,
      evidenceRequirements: defaultEvidence(),
      methodologyNotes: "Digital maturity alignment for prepayment and credit model fit.",
      predicate: {
        type: "category_in",
  ...
  requiredGates: [
    {
      ...
      description: "Loan and market data readiness requires an organization profile observation.",
      requiredEvidenceTypes: ["organization_profile"],
    },
  ],
  rules: [
    buildRule({
      ...
      capabilityId: DQ_ID,
      factorCategory: "organizational_profile_fit",
      title: "Profile evidence supports loan and market data readiness review",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: DQ_ID,
      factorCategory: "publicly_evidenced_need",
      title: "Data availability indicates loan and market data readiness",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: DQ_ID,
      factorCategory: "capability_alignment",
      title: "Ownership model aligns with loan-data readiness workflows",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: DQ_ID,
      factorCategory: "capability_alignment",
      title: "Lending breadth supports loan and market data themes",
    ...
    buildRule({
      ...
      capabilityId: DQ_ID,
      factorCategory: "operational_compatibility",
      title: "Larger scale benefits from loan and market data readiness",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: DQ_ID,
      factorCategory: "publicly_evidenced_need",
      title: "Profile freshness supports loan and market data scoring",
...
const portfolioReportingRuleSet = parseRuleSet({
  ...
  rules: [
    buildRule({
      ...
      capabilityId: PR_ID,
      factorCategory: "organizational_profile_fit",
      title: "Institution profile supports valuation and risk reporting",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: PR_ID,
      factorCategory: "organizational_profile_fit",
      title: "Scale band supports valuation and risk reporting needs",
    ...
    buildRule({
      ...
      capabilityId: PR_ID,
      factorCategory: "operational_compatibility",
      title: "Multi-region footprint increases valuation reporting relevance",
    ...
    buildRule({
      ...
      capabilityId: PR_ID,
      factorCategory: "operational_compatibility",
      title: "Operating complexity supports valuation and risk reporting workflows",
    ...
    buildRule({
      ...
      capabilityId: PR_ID,
      factorCategory: "capability_alignment",
      title: "Digital maturity aligns with valuation reporting delivery",
    ...
    buildRule({
      ...
      capabilityId: PR_ID,
      factorCategory: "publicly_evidenced_need",
      title: "Operating context evidence supports valuation reporting",
...
const scenarioPlanningRuleSet = parseRuleSet({
  ...
  rules: [
    buildRule({
      ...
      capabilityId: SP_ID,
      factorCategory: "organizational_profile_fit",
      title: "Institution kind fits macro and stress scenario scope",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: SP_ID,
      factorCategory: "operational_compatibility",
      title: "Higher complexity strengthens macro and stress scenario fit",
    ...
    buildRule({
      ...
      capabilityId: SP_ID,
      factorCategory: "capability_alignment",
      title: "Digital maturity supports macro scenario workflows",
    ...
    buildRule({
      ...
      capabilityId: SP_ID,
      factorCategory: "timing_change_signals",
      title: "Change signals within scenario-planning window",
    ...
    buildRule({
      ...
      capabilityId: SP_ID,
      factorCategory: "capability_alignment",
      title: "Lending breadth supports macro and stress scenario themes",
    ...
    buildRule({
      ...
      capabilityId: SP_ID,
      factorCategory: "publicly_evidenced_need",
      title: "Profile freshness supports macro scenario scoring",
...
const governanceReviewRuleSet = parseRuleSet({
  ...
  rules: [
    buildRule({
      ...
      capabilityId: GOV_ID,
      factorCategory: "organizational_profile_fit",
      title: "Profile evidence supports model validation and governance review",
    ...
    buildRule({
      ...
      capabilityId: GOV_ID,
      factorCategory: "capability_alignment",
      title: "Ownership model aligns with model-governance themes",
    ...
    buildRule({
      ...
      capabilityId: GOV_ID,
      factorCategory: "publicly_evidenced_need",
      title: "Data availability informs model validation review",
      rationale:
    ...
    buildRule({
      ...
      capabilityId: GOV_ID,
      factorCategory: "operational_compatibility",
      title: "Scale band supports model validation and governance review",
    ...
    buildRule({
      ...
      capabilityId: GOV_ID,
      factorCategory: "capability_alignment",
      title: "Digital maturity aligns with model-governance workflows",
